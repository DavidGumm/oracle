...
test("Test oracle action", () => {
    ...
    expect(results.state.memory.frontMemory).toMatch(/ But you fail horrifically.| You succeed.| But you fail!/);
    expect(results.state.message).toMatch(/You fail horrifically|You succeed.|You fail!/);
